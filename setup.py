...
source_database = path.abspath(path.abspath(path.join(source_dir, "Database/", "database.db")))

destination_dir = path.dirname(__file__) 
destination_data_dir = path.abspath(path.abspath(path.join(destination_dir, "Data/")))
destination_database = path.abspath(path.abspath(path.join(destination_dir, "database.db")))
