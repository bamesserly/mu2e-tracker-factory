...
# Form implementation generated from reading ui file 'silver.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(130, 340, 81, 16))
        self.label_3.setObjectName("label_3")
        self.label_2 = QtWidgets.QLabel(self.tab)
        self.label_2.setGeometry(QtCore.QRect(620, 90, 81, 16))
        self.label_2.setObjectName("label_2")
        self.portal3 = QtWidgets.QPushButton(self.tab)
        self.portal3.setGeometry(QtCore.QRect(130, 400, 231, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.portal4.setGeometry(QtCore.QRect(620, 400, 231, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.portal1.setGeometry(QtCore.QRect(130, 150, 231, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label.setGeometry(QtCore.QRect(130, 90, 81, 16))
        self.label.setObjectName("label")
        self.portal2 = QtWidgets.QPushButton(self.tab)
        self.portal2.setGeometry(QtCore.QRect(620, 150, 231, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(620, 340, 81, 16))
        ...
        self.label_6.setGeometry(QtCore.QRect(140, 40, 111, 16))
        font = QtGui.QFont()
        ...
        self.palletNumInput.setGeometry(QtCore.QRect(230, 40, 113, 20))
        ...
        self.epoxyBatchInput.setGeometry(QtCore.QRect(230, 80, 111, 20))
        self.epoxyBatchInput.setText("")
        self.epoxyBatchInput.setObjectName("epoxyBatchInput")
        self.label_7 = QtWidgets.QLabel(self.tab_2)
        self.label_7.setGeometry(QtCore.QRect(10, 70, 231, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.start.setGeometry(QtCore.QRect(70, 120, 271, 91))
        font = QtGui.QFont()
        ...
        self.finishInsertion.setGeometry(QtCore.QRect(70, 310, 271, 91))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.commentBox.setGeometry(QtCore.QRect(373, 60, 521, 241))
        self.commentBox.setObjectName("commentBox")
        self.label_9 = QtWidgets.QLabel(self.tab_2)
        self.label_9.setGeometry(QtCore.QRect(400, 30, 231, 21))
        font = QtGui.QFont()
        ...
        self.finish.setGeometry(QtCore.QRect(490, 310, 271, 91))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.viewButton.setGeometry(QtCore.QRect(310, 680, 241, 101))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
