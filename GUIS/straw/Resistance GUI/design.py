...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reset_button = QtWidgets.QPushButton(self.resistance_tab)      #calls reset() in main.py
        self.save_button = QtWidgets.QPushButton(self.resistance_tab)       #calls saveReset() in main.py
        self.editPallet_button = QtWidgets.QPushButton(self.resistance_tab) #calls editPallet() in main.py
