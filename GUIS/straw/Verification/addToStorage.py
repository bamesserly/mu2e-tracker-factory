...
def main():
    ...
    if (p % 2 ==0):
        position = 92
    pathToPallet = os.path.dirname(__file__) + "\\..\\..\\..\\Data\\Pallets\\" + palID + "\\" + palNum + ".csv"
    with open(pathToPallet) as csvf:
        ...
        for line in reader:
            ...
            if not line[1] == 'silv':
                continue
            pathToStorage = os.path.dirname(__file__) + "\\..\\..\\..\\Data\\Straw storage\\storage.csv"
            ...
            for j in line:
                ...
                #    position = position - 4
                #    continue
                string_input = str(position) + ',' + j + ',' + date + ',' + worker + '\n'
